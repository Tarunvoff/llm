...
function FigmaIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M20 12C20 14.208 18.208 16 16 16C13.792 16 12 14.208 12 12C12 9.792 13.792 8 16 8H12V0Z" fill="currentColor"/>
    </svg>
  )
}
...
export const models: Model[] = [
  { id: 'vidhya-20b', name: 'Vidhya 2.0', description: 'STEM Specialist (Ours)', icon: <Bolt className="size-4 text-amber-400" />, badge: 'Default' },
  { id: 'sonnet-4.5', name: 'Sonnet 4.5', description: 'Fast & intelligent', icon: <Zap className="size-4 text-blue-400" /> },
...
export function ModelSelector({ selectedModel = 'vidhya-20b', onModelChange }: { 
...
// CHAT INPUT
export function ChatInput({ onSend, placeholder = "What do you want to build or solve in STEM?" }: {
        ...
        <div className="flex items-center justify-between px-3 pb-3 pt-1">
                ...
                <>
                  ...
                  <div className="absolute bottom-full left-0 mb-2 z-50 bg-[#1a1a1e]/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl shadow-black/50 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
                    <div className="p-1.5 min-w-[180px]">
                      {[
                        { icon: <Paperclip className="size-4" />, label: 'Upload problem / PDF' },
                        { icon: <Image className="size-4" />, label: 'Add diagram / image' },
                        { icon: <FileCode className="size-4" />, label: 'Import LaTeX / formula' }
                      ].map((item, i) => (
                        <button 
                          key={i} 
                          type="button"
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">Socratic Mode</span>
            </button>
            ...
            >
              <span className="hidden sm:inline">Solve now</span>
  ...
  return (
    <div className="flex items-center gap-4 justify-center">
      ...
      <div className="flex gap-2">
        {[
          { id: 'latex', name: 'LaTeX', icon: <FileCode className="size-4" /> },
...
export function BoltStyleChat({
  title = "What will you",
  subtitle = "Experience deep STEM reasoning & Socratic problem solving with AI.",
  announcementText = "Introducing Vidhya V2",
  announcementHref = "#",
  placeholder = "Ask a JEE, NEET, or Olympiad question (e.g. Solve ∫ x·e^(2x) dx)...",
  onSend,
  onImport
}: BoltChatProps) {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-80px)] w-full overflow-hidden bg-[#0f0f0f]">
      <RayBackground />
      <div className="absolute top-[30px] sm:top-[50px] z-10">
        {/* Announcement badge */}
