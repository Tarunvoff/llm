...
OFFICIAL_BENCHMARKS = {
    "title": "Vidhya 2.0 Official Model Card Results",
    "source": "https://huggingface.co/VidhyaAI/Vidhya-2.0",
    ...
    "token_efficiency": {
        ...
        "summary": "Vidhya 2.0 achieves the best accuracy-per-token ratio of all evaluated models, using up to 64% fewer output tokens than the base model.",
        "table": [
            {"model": "Vidhya 2.0 (ours)", "in_dist_pass1": 88.95, "in_dist_tokens": 2102, "in_dist_acc_per_1k": 42.31, "ood_pass1": 87.64, "ood_tokens": 2214, "ood_acc_per_1k": 39.58, "highlight": True},
