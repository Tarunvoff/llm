...
OFFICIAL_BENCHMARKS = {
    "title": "Aryabhata 2.0 Official Model Card Results",
    ...
    "in_distribution": {
        ...
        "comparison_table": [
            ...
            {"model": "Aryabhata 2 (ours)", "jee_adv_2025": 86.51, "neet_2025": 84.66, "jee_main_2025": 87.80, "jee_main_2026": 92.99, "avg": 88.95, "highlight": True},
    ...
    "out_of_distribution": {
        ...
        "comparison_table": [
            ...
            {"model": "Aryabhata 2 (ours)", "aime": 86.67, "hmmt": 78.96, "gpqa": 74.86, "mmlu_pro": 88.49, "mmlu_redux": 92.92, "avg": 87.64, "highlight": True},
    ...
    "token_efficiency": {
        ...
        "summary": "Aryabhata 2 achieves the best accuracy-per-token ratio of all evaluated models, using up to 64% fewer output tokens than the base model.",
        "table": [
            {"model": "Aryabhata 2 (ours)", "in_dist_pass1": 88.95, "in_dist_tokens": 2102, "in_dist_acc_per_1k": 42.31, "ood_pass1": 87.64, "ood_tokens": 2214, "ood_acc_per_1k": 39.58, "highlight": True},
